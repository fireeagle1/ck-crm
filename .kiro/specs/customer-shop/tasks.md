...
- [x] 1. Database migrations and model foundations
  - [x] 1.1 Create migrations for customer_tiers and customer_tier_assignments tables
  ...
  - [x] 1.2 Create migration for products table
  ...
  - [x] 1.3 Create migrations for product_visibilities, product_visibility_customers, and product_visibility_tiers tables
  ...
  - [x] 1.4 Create migrations for orders and order_items tables
  ...
  - [x] 1.5 Create Eloquent models: Product, ProductVisibility, CustomerTier, Order, OrderItem
...
- [x] 3. Service layer implementation
  ...
  - [x] 3.3 Implement CheckoutService
  ...
  - [x] 3.4 Implement FulfilmentService
  ...
  - [x]* 3.7 Write unit tests for CheckoutService item partitioning
    - **Property 9: Checkout Correctly Partitions Items by Payment Type**
    - **Validates: Requirements 4.4, 4.5, 4.6**

- [x] 4. Admin controllers and views - Product management
  - [x] 4.1 Implement Admin\ShopProductController
  ...
  - [x] 4.2 Create admin product Blade views
  ...
  - [x]* 4.3 Write feature tests for product validation
    - **Property 1: Product Validation Rejects Incomplete Data**
    - **Property 2: Recurring Product Requires Billing Frequency**
    - **Validates: Requirements 1.2, 1.3**

- [x] 5. Admin controllers and views - Customer tiers
  - [x] 5.1 Implement Admin\CustomerTierController
  ...
  - [x] 5.2 Create admin tier Blade view
...
- [x] 6. Portal controllers and views - Shop browsing
  - [x] 6.1 Implement Portal\ShopController
  ...
  - [x] 6.2 Create portal shop Blade views
  ...
  - [x]* 6.3 Write feature tests for product visibility
  ...
  - [x]* 6.4 Write feature tests for shop filtering and search
    - **Property 6: Type Filter Returns Only Matching Products**
    - **Property 7: Search Returns Only Relevant Products**
    - **Validates: Requirements 3.3, 3.4**

- [x] 7. Portal controllers and views - Cart and checkout
  - [x] 7.1 Implement Portal\CartController
  ...
  - [x] 7.2 Create portal cart Blade view
  ...
  - [x]* 7.3 Write feature tests for checkout flow
    - **Property 10: Stripe Customer Ensured Before Payment**
    - **Property 11: Failed Payment Preserves Cart**
    - **Validates: Requirements 4.7, 4.8**

- [x] 8. Checkpoint - Verify admin and portal flows work end-to-end
  - Ensure all tests pass, ask the user if questions arise.

- [x] 9. Stripe webhook handling
  - [x] 9.1 Implement StripeWebhookController
  ...
  - [x]* 9.2 Write feature tests for webhook handling
...
- [x] 10. Fulfilment workflows
  - [x] 10.1 Implement Admin\ShopOrderController
  ...
  - [x] 10.2 Create admin order Blade views
  ...
  - [x]* 10.3 Write feature tests for fulfilment
...
- [x] 11. Portal order history
  - [x] 11.1 Implement Portal\OrderController
  ...
  - [x] 11.2 Create portal order Blade views
...
- [x] 12. Routes and integration wiring
  - [x] 12.1 Register all routes in web.php
  ...
  - [x] 12.2 Register service providers and bind services
