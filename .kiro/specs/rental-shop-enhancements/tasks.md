...
- [x] 3. Admin product question management
  ...
  - [x] 3.3 Add Alpine.js product questions UI section to product edit view
  ...
  - [x]* 3.4 Write unit tests for syncProductQuestions logic
    - Test adding, editing, removing questions; verify display_order; verify answers preserved on deletion
    - _Requirements: 1.2, 1.3, 1.4, 1.5, 1.6, 1.7_

- [x] 4. Checkout question collection
  - [x] 4.1 Extend checkout view to render product questions
  ...
  - [x] 4.2 Extend CheckoutService to validate and persist question answers
  ...
  - [x]* 4.3 Write property test for checkout validation respects required flag
    - **Property 3: Checkout validation respects required flag**
    - **Validates: Requirements 2.3, 2.4**

  - [x]* 4.4 Write property test for question answer round-trip persistence
    - **Property 4: Question answer round-trip persistence**
    - **Validates: Requirements 2.5**

  - [x]* 4.5 Write property test for input type to HTML control mapping
    - **Property 5: Input type to HTML control mapping**
    - **Validates: Requirements 2.2**

- [x] 5. Checkpoint - Verify question flow end-to-end
...
- [x] 6. Admin order detail — answer display and fulfilment timeline
  - [x] 6.1 Extend ShopOrderController `show()` to eager-load question answers
    - Add `items.questionAnswers` to eager load chain
    - _Requirements: 3.1_

  - [x] 6.2 Add question answers display section to admin order detail view
  ...
  - [x] 6.3 Create FulfilmentTimeline Blade component
...
- [x] 7. Admin bookings list — quick action buttons
  ...
  - [x] 7.3 Add `markReturnedFromList()` method to BookingController
  ...
  - [x] 7.4 Register admin routes for quick actions
  ...
  - [x] 7.5 Add quick action buttons to bookings list view
  ...
  - [x]* 7.6 Write property tests for button visibility conditions
...
- [x] 8. Inspection Report PDF
  - [x] 8.1 Create InspectionReportPdfService
  ...
  - [x] 8.2 Create inspection report PDF Blade view
  ...
  - [x] 8.3 Create BookingInspectionReportController
  ...
  - [x]* 8.4 Write property test for inspection report PDF content completeness
    - **Property 8: Inspection report PDF content completeness**
    - **Validates: Requirements 5.3**

- [x] 9. Checkpoint - Verify admin features
...
- [x] 10. Portal order detail enhancements
  - [x] 10.1 Extend Portal OrderController `show()` with eager loading
  ...
  - [x] 10.2 Create portal booking details partial
  ...
  - [x] 10.3 Create portal inspections partial with photo gallery
  ...
  - [x] 10.4 Create portal question answers partial
  ...
  - [x] 10.5 Integrate partials into portal order detail view
  ...
  - [x]* 10.6 Write property test for portal rental booking detail display
    - **Property 11: Portal rental booking detail display**
    - **Validates: Requirements 8.1, 8.2, 8.3**

  - [x]* 10.7 Write property test for portal inspection privacy filter
    - **Property 12: Portal inspection privacy filter**
    - **Validates: Requirements 10.5**

  - [x]* 10.8 Write property test for portal inspection display completeness
    - **Property 13: Portal inspection display completeness**
    - **Validates: Requirements 10.1, 10.2, 10.4**

  - [x]* 10.9 Write property test for customer-facing stage label mapping
    - **Property 15: Customer-facing stage label mapping**
    - **Validates: Requirements 8.3, 13.3**

- [x] 11. Portal inspection photo access route
  - [x] 11.1 Create Portal InspectionPhotoController
...
- [x] 12. Mobile responsiveness pass
  - [x] 12.1 Apply responsive Tailwind utilities to portal order detail and partials
...
- [x] 14. Backend: Extend inspect endpoint to accept signature data
  - [x] 14.1 Add signature_data validation rule to inspect endpoint
  ...
  - [x] 14.2 Store signature on booking after checkout inspection
  ...
  - [x] 14.3 Display signature on admin order detail
...
- [x] 15. iOS: MultipartFormData helper + APIClient extension
  - [x] 15.1 Create MultipartFormData struct
  ...
  - [x] 15.2 Add uploadMultipart method to APIClient
...
- [x] 16. iOS: Shared inspection components
  - [x] 16.1 Create PhotoCaptureStep view
  ...
  - [x] 16.2 Create ConditionNotesStep view
  ...
  - [x] 16.3 Create StepProgressBar view
  ...
  - [x] 16.4 Create DamageFlagStep view
...
- [x] 17. iOS: SignatureView + SignatureStep
  - [x] 17.1 Create SignatureView canvas
  ...
  - [x] 17.2 Create SignatureStep wrapper
...
- [x] 18. iOS: CheckoutInspectionView + ViewModel
  - [x] 18.1 Create CheckoutInspectionViewModel
  ...
  - [x] 18.2 Create CheckoutInspectionView
...
- [x] 19. iOS: ReturnInspectionView + ViewModel
  - [x] 19.1 Create ReturnInspectionViewModel
  ...
  - [x] 19.2 Create ReturnInspectionView
...
- [x] 20. iOS: FulfilmentStageIndicator component
  - [x] 20.1 Create StageConfig and FulfilmentStageIndicator view
...
- [x] 21. iOS: Stage action buttons on BookingDetailView
  - [x] 21.1 Create StageAction enum and action mapping
  ...
  - [x] 21.2 Integrate FulfilmentStageIndicator into BookingDetailView
  ...
  - [x] 21.3 Add stage action buttons to BookingDetailView
  ...
  - [x] 21.4 Implement sheet presentation for inspection flows
  ...
  - [x] 21.5 Implement simple API call for advance actions
...
- [x] 22. Checkpoint - iOS inspection flows complete
