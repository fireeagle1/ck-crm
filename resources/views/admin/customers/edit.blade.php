<x-admin-layout>
    <x-slot:title>Edit {{ $customer->company_name }}</x-slot:title>

    <div class="flex items-center justify-between mb-4">
        <h1 class="text-2xl font-semibold">Edit Customer</h1>
        <a href="{{ route('admin.customers.show', $customer) }}" class="text-sm text-blue-600 hover:underline">&larr; Back</a>
    </div>
        ...
        <form method="POST" action="{{ route('admin.customers.update', $customer) }}">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="stripe_customer_id" id="stripe_customer_id"
                               value="{{ old('stripe_customer_id', $customer->stripe_customer_id) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500"
                               placeholder="cus_...">
                    </div>
                </div>
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <a href="{{ route('admin.customers.show', $customer) }}" class="px-4 py-2 border rounded-md text-sm font-medium hover:bg-gray-50">
                        Cancel
                    </a>
                </div>
            </div>
