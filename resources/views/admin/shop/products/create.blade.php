        ...
        <form method="POST" action="{{ route('admin.shop.products.store') }}" enctype="multipart/form-data">
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <x-rich-text-editor name="description" :value="old('description')" placeholder="Describe the product..." :required="true" />
                ...
                <div x-show="productType === 'equipment_rental'" x-transition class="border-t pt-5 space-y-5">
                    ...
                    <div>
                        ...
                        <x-rich-text-editor name="rental_agreement_text" :value="old('rental_agreement_text')" placeholder="Enter the rental agreement terms customers must accept..." />
