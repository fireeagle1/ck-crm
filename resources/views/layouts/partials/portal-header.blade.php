    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="h-16 flex items-center justify-between">
            ...
            <a href="{{ route('portal.cart.index') }}" class="relative p-2 text-gray-300 hover:text-white transition" title="View Cart">
                ...
                @if ($cartItemCount > 0)
                    <span class="absolute -top-0.5 -right-0.5 inline-flex items-center justify-center h-5 min-w-[1.25rem] px-1 rounded-full bg-blue-600 text-white text-xs font-bold">
                        {{ $cartItemCount }}
                    </span>
                @endif
            </a>
            ...
            <div class="md:hidden flex items-center gap-2" x-data="{ mobileOpen: false }">
                ...
                <a href="{{ route('portal.cart.index') }}" class="relative p-2 text-gray-300 hover:text-white transition" title="View Cart">
                    ...
                    @if ($cartItemCount > 0)
                        <span class="absolute -top-0.5 -right-0.5 inline-flex items-center justify-center h-4 min-w-[1rem] px-0.5 rounded-full bg-blue-600 text-white text-[10px] font-bold">
                            {{ $cartItemCount }}
                        </span>
                    @endif
                </a>
